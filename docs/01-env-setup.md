...
The first CloudFormation you run will create the initial pipeline.  Before you deploy the CloudFormation template feel free to view it <a href="https://github.com/aws-samples/aws-container-devsecops-workshop/blob/master/pipeline-setup.yml" target="_blank">here</a href>.

1. Create the CloudFormation stack:

```
aws cloudformation create-stack \
    --stack-name container-dso-wksp-pipeline-stack \
    --template-url https://s3.us-east-2.amazonaws.com/sa-security-specialist-workshops-us-east-2/devsecops/containers/pipeline-setup.yml \
...
```
aws cloudformation create-stack \
    --stack-name container-dso-wksp-anchore-stack \
    --template-url https://s3.us-east-2.amazonaws.com/sa-security-specialist-workshops-us-east-2/devsecops/containers/anchore-fargate.yml \
...
https://s3-us-west-2.amazonaws.com/sa-security-specialist-workshops-us-east-2/threat-detect-workshop/staging/01-environment-setup.yml
